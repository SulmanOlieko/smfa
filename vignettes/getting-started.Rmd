---
title: "Getting Started with smfa"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with smfa}
...
```{r quickstart-fit, fold.output=TRUE}
meta_lp <- smfa(
...
```{r quickstart-summary, fold.output=TRUE}
summary(meta_lp)
```

### Step 4: Extract firm-level efficiencies

```{r quickstart-eff, fold.output=TRUE}
